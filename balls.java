...
int x = 10, y = 10,sang1 = 0, sang2 = 0, he = 1200 , wi = 1200;
public void init()
{
...
g.fillArc(x,10,50,50,sang1,90);
g.setColor(new Color(r.nextInt(255),r.nextInt(255),r.nextInt(255)));
g.fillArc(x,10,50,50,sang1 + 90,90);
g.setColor(new Color(r.nextInt(255),r.nextInt(255),r.nextInt(255)));
g.fillArc(x,10,50,50,sang1 + 180,90);
g.setColor(new Color(r.nextInt(255),r.nextInt(255),r.nextInt(255)));
g.fillArc(x,10,50,50,sang1 + 270,90);
g.setColor(new Color(r.nextInt(255),r.nextInt(255),r.nextInt(255)));
